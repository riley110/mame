...
static MACHINE_CONFIG_FRAGMENT( msx2p_floplist )
	...
	MCFG_SOFTWARE_LIST_COMPATIBLE_ADD("msx2_flop_list","msx2_flop")
	MCFG_SOFTWARE_LIST_COMPATIBLE_ADD("msx1_flop_list","msx1_flop")
MACHINE_CONFIG_END

static MACHINE_CONFIG_FRAGMENT( turbor_floplist )
	MCFG_SOFTWARE_LIST_ADD("flop_list","turbor_flop")
	MCFG_SOFTWARE_LIST_COMPATIBLE_ADD("msx2p_flop_list","msx2p_flop")
	MCFG_SOFTWARE_LIST_COMPATIBLE_ADD("msx2_flop_list","msx2_flop")
	MCFG_SOFTWARE_LIST_COMPATIBLE_ADD("msx1_flop_list","msx1_flop")
MACHINE_CONFIG_END
...
static MACHINE_CONFIG_START( msx2, msx_state )
	...
	MCFG_SOFTWARE_LIST_COMPATIBLE_ADD("msx1_cass_list","msx1_cass")
MACHINE_CONFIG_END
...
static MACHINE_CONFIG_DERIVED( fsa1gt, msx2 )
	...
	MCFG_FRAGMENT_ADD( msx_tc8566af )
	MCFG_FRAGMENT_ADD( msx_1_35_dd_drive )
	MCFG_FRAGMENT_ADD( turbor_floplist )
