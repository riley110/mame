...
void exelv_state::exl100(machine_config &config)
{
	...
	SOFTWARE_LIST(config, "cart_list").set_original("exl100_cart");
	SOFTWARE_LIST(config, "cass_list").set_original("exl100_cass");
	SOFTWARE_LIST(config, "flop_list").set_original("exl100_flop");
}
...
void exelv_state::exeltel(machine_config &config)
{
	...
	SOFTWARE_LIST(config, "flop_list").set_original("exeltel_flop");
}
