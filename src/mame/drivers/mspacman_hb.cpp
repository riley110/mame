...
GAME( 2000, msheartsb,mspacman, woodpek,  mspacman, driver_device, 0,        ROT90, "[Midway]", "Ms. Pacman Hearts (set 2)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1998, mspacii3, mspacman, mspacii,  mspacman, driver_device, 0,        ROT90, "Orca", "Ms. Pacman II (from HBMAME)", MACHINE_SUPPORTS_SAVE )
