...
GAME( 1980, tvortex,   tempest, tempest, tempest, driver_device, 0,    ROT270, "Atari", "Vortex (Tempest hack)", MACHINE_SUPPORTS_SAVE )
GAME( 1980, tvortexa,  tempest, tempest, tempest, driver_device, 0,    ROT270, "Atari", "Vortex (Tempest hack, alt version)", MACHINE_SUPPORTS_SAVE )
