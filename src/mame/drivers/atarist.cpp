...
void ste_state::tt030(machine_config &config)
{
	...
	SOFTWARE_LIST(config, "tt_flop_list").set_type("st_tt", SOFTWARE_LIST_ORIGINAL_SYSTEM);
}
...
void ste_state::falcon(machine_config &config)
{
	...
	SOFTWARE_LIST(config, "falc_flop_list").set_type("st_falcon", SOFTWARE_LIST_ORIGINAL_SYSTEM);
}
