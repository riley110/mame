...
void vic20_state::vic20(machine_config &config, const char* softlist_filter)
{
	...
	SOFTWARE_LIST(config, "cart_list").set_type("vic20_cart", SOFTWARE_LIST_ORIGINAL_SYSTEM).set_filter(softlist_filter);
	SOFTWARE_LIST(config, "cass_list").set_type("vic20_cass", SOFTWARE_LIST_ORIGINAL_SYSTEM).set_filter(softlist_filter);
	SOFTWARE_LIST(config, "flop_list").set_type("vic20_flop", SOFTWARE_LIST_ORIGINAL_SYSTEM).set_filter(softlist_filter);
